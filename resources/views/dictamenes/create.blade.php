    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Nuevo Dictamen</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('dictamenes.store') }}" id="dictamenForm">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('tipo_dictamen') is-invalid @enderror" 
                                    ...
                                    <option value="inicial" {{ old('tipo_dictamen') == 'inicial' ? 'selected' : '' }}>Inicial</option>
                                    <option value="periodico" {{ old('tipo_dictamen') == 'periodico' ? 'selected' : '' }}>Periódico</option>
                                    <option value="extraordinario" {{ old('tipo_dictamen') == 'extraordinario' ? 'selected' : '' }}>Extraordinario</option>
                                </select>
                                @error('tipo_dictamen')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
