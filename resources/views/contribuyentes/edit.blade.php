    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Contribuyente: {{ $contribuyente['razon_social'] }}</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('contribuyentes.update', $contribuyente['id']) }}" id="contribuyenteForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="rfc" 
                                       name="rfc" 
                                       value="{{ old('rfc', $contribuyente['rfc']) }}" 
                                       maxlength="13"
                                       required>
                                @error('rfc')
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="razon_social" 
                                       name="razon_social" 
                                       value="{{ old('razon_social', $contribuyente['razon_social']) }}" 
                                       required>
                                @error('razon_social')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('nombre_comercial', $contribuyente['nombre_comercial']) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="regimen_fiscal" 
                                       name="regimen_fiscal" 
                                       value="{{ old('regimen_fiscal', $contribuyente['regimen_fiscal']) }}" 
                                       required>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('domicilio_fiscal', $contribuyente['domicilio_fiscal']) }}" 
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="codigo_postal" 
                                       name="codigo_postal" 
                                       value="{{ old('codigo_postal', $contribuyente['codigo_postal']) }}" 
                                       maxlength="5"
                                       required>
                                @error('codigo_postal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="telefono" 
                                       name="telefono" 
                                       value="{{ old('telefono', $contribuyente['telefono']) }}">
                                @error('telefono')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="{{ old('email', $contribuyente['email']) }}">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('representante_legal', $contribuyente['representante_legal']) }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('representante_rfc', $contribuyente['representante_rfc']) }}" 
                                       maxlength="13">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('caracter_actua') is-invalid @enderror" 
                                    ...
                                    <option value="contratista" {{ old('caracter_actua', $contribuyente['caracter_actua']) == 'contratista' ? 'selected' : '' }}>Contratista</option>
                                    <option value="asignatario" {{ old('caracter_actua', $contribuyente['caracter_actua']) == 'asignatario' ? 'selected' : '' }}>Asignatario</option>
                                    <option value="permisionario" {{ old('caracter_actua', $contribuyente['caracter_actua']) == 'permisionario' ? 'selected' : '' }}>Permisionario</option>
                                    <option value="usuario" {{ old('caracter_actua', $contribuyente['caracter_actua']) == 'usuario' ? 'selected' : '' }}>Usuario</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="numero_permiso" 
                                       name="numero_permiso" 
                                       value="{{ old('numero_permiso', $contribuyente['numero_permiso']) }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="tipo_permiso" 
                                       name="tipo_permiso" 
                                       value="{{ old('tipo_permiso', $contribuyente['tipo_permiso']) }}">
                                @error('tipo_permiso')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('proveedor_equipos_rfc', $contribuyente['proveedor_equipos_rfc']) }}" 
                                       maxlength="13">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('proveedor_equipos_nombre', $contribuyente['proveedor_equipos_nombre']) }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('contribuyentes.show', $contribuyente['id']) }}" class="btn btn-info">
