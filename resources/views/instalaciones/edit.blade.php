    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Instalación: {{ $instalacion['nombre'] }}</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('instalaciones.update', $instalacion['id']) }}" id="instalacionForm">
                    @csrf
                    @method('PUT')
                                ...
                                <select class="form-select select2 @error('contribuyente_id') is-invalid @enderror" 
                                    ...
                                    @foreach($contribuyentes['data'] ?? [] as $contribuyente)
                                        <option value="{{ $contribuyente['id'] }}" 
                                            {{ old('contribuyente_id', $instalacion['contribuyente_id']) == $contribuyente['id'] ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('clave_instalacion', $instalacion['clave_instalacion']) }}" 
                                       maxlength="50"
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('tipo_instalacion') is-invalid @enderror" 
                                    ...
                                    <option value="almacenamiento" {{ old('tipo_instalacion', $instalacion['tipo_instalacion']) == 'almacenamiento' ? 'selected' : '' }}>Almacenamiento</option>
                                    <option value="transporte" {{ old('tipo_instalacion', $instalacion['tipo_instalacion']) == 'transporte' ? 'selected' : '' }}>Transporte</option>
                                </select>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="domicilio" 
                                       name="domicilio" 
                                       value="{{ old('domicilio', $instalacion['domicilio']) }}" 
                                       required>
                                @error('domicilio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('horario_atencion', $instalacion['horario_atencion']) }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="ip_servidor" 
                                       name="ip_servidor" 
                                       value="{{ old('ip_servidor', $instalacion['ip_servidor']) }}">
                                @error('ip_servidor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('puerto_servidor', $instalacion['puerto_servidor']) }}" 
                                       min="1" 
                                       max="65535">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('protocolo_comunicacion') is-invalid @enderror" 
                                    ...
                                    <option value="">Seleccione...</option>
                                    <option value="TCP" {{ old('protocolo_comunicacion', $instalacion['protocolo_comunicacion']) == 'TCP' ? 'selected' : '' }}>TCP</option>
                                    <option value="UDP" {{ old('protocolo_comunicacion', $instalacion['protocolo_comunicacion']) == 'UDP' ? 'selected' : '' }}>UDP</option>
                                    <option value="HTTP" {{ old('protocolo_comunicacion', $instalacion['protocolo_comunicacion']) == 'HTTP' ? 'selected' : '' }}>HTTP</option>
                                    <option value="HTTPS" {{ old('protocolo_comunicacion', $instalacion['protocolo_comunicacion']) == 'HTTPS' ? 'selected' : '' }}>HTTPS</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('intervalo_comunicacion', $instalacion['intervalo_comunicacion']) }}" 
                                       min="1">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('timeout_comunicacion', $instalacion['timeout_comunicacion']) }}" 
                                       min="1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_temperatura_min', $instalacion['umbral_temperatura_min']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_temperatura_max', $instalacion['umbral_temperatura_max']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_presion_min', $instalacion['umbral_presion_min']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_presion_max', $instalacion['umbral_presion_max']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_nivel_min', $instalacion['umbral_nivel_min']) }}" 
                                       min="0" 
                                       max="100">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_nivel_max', $instalacion['umbral_nivel_max']) }}" 
                                       min="0" 
                                       max="100">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_flujo_min', $instalacion['umbral_flujo_min']) }}" 
                                       min="0">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_flujo_max', $instalacion['umbral_flujo_max']) }}" 
                                       min="0">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('instalaciones.show', $instalacion['id']) }}" class="btn btn-info">
