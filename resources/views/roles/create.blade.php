                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="nivel_jerarquico" name="nivel_jerarquico" 
                                   value="{{ old('nivel_jerarquico', 1) }}" min="1" max="100" required>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="es_administrador" 
                                   name="es_administrador" value="1" {{ old('es_administrador') ? 'checked' : '' }}>
                            <label class="form-check-label" for="es_administrador">
                                Este rol es de administrador (tiene todos los permisos automáticamente)
                            </label>
                        </div>
                    </div>
