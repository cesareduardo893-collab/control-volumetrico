    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Tanque: {{ $tanque['nombre'] }}</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('tanques.update', $tanque['id']) }}" id="tanqueForm">
                    @csrf
                    @method('PUT')
                                ...
                                <select class="form-select select2 @error('instalacion_id') is-invalid @enderror" 
                                    ...
                                    @foreach($instalaciones['data'] ?? [] as $instalacion)
                                        <option value="{{ $instalacion['id'] }}" 
                                            {{ old('instalacion_id', $tanque['instalacion_id']) == $instalacion['id'] ? 'selected' : '' }}>
                                ...
                                <select class="form-select select2 @error('producto_id') is-invalid @enderror" 
                                    ...
                                    @foreach($productos['data'] ?? [] as $producto)
                                        <option value="{{ $producto['id'] }}" 
                                            {{ old('producto_id', $tanque['producto_id']) == $producto['id'] ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="clave_tanque" 
                                       name="clave_tanque" 
                                       value="{{ old('clave_tanque', $tanque['clave_tanque']) }}" 
                                       maxlength="50"
                                       required>
                                @error('clave_tanque')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="ubicacion" 
                                       name="ubicacion" 
                                       value="{{ old('ubicacion', $tanque['ubicacion']) }}" 
                                       required>
                                @error('ubicacion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="capacidad" 
                                       name="capacidad" 
                                       value="{{ old('capacidad', $tanque['capacidad']) }}" 
                                       min="0" 
                                       step="0.01"
                                       required>
                                @error('capacidad')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('capacidad_operativa', $tanque['capacidad_operativa']) }}" 
                                       min="0" 
                                       step="0.01"
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('capacidad_seguridad', $tanque['capacidad_seguridad']) }}" 
                                       min="0" 
                                       step="0.01"
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="diametro" 
                                       name="diametro" 
                                       value="{{ old('diametro', $tanque['diametro']) }}" 
                                       min="0" 
                                       step="0.01">
                                @error('diametro')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="longitud" 
                                       name="longitud" 
                                       value="{{ old('longitud', $tanque['longitud']) }}" 
                                       min="0" 
                                       step="0.01">
                                @error('longitud')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="altura_total" 
                                       name="altura_total" 
                                       value="{{ old('altura_total', $tanque['altura_total']) }}" 
                                       min="0" 
                                       step="0.01">
                                @error('altura_total')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('altura_operativa', $tanque['altura_operativa']) }}" 
                                       min="0" 
                                       step="0.01">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('altura_seguridad', $tanque['altura_seguridad']) }}" 
                                       min="0" 
                                       step="0.01">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('forma') is-invalid @enderror" 
                                    ...
                                    <option value="cilindrico" {{ old('forma', $tanque['forma']) == 'cilindrico' ? 'selected' : '' }}>Cilíndrico</option>
                                    <option value="rectangular" {{ old('forma', $tanque['forma']) == 'rectangular' ? 'selected' : '' }}>Rectangular</option>
                                    <option value="esferico" {{ old('forma', $tanque['forma']) == 'esferico' ? 'selected' : '' }}>Esférico</option>
                                </select>
                                @error('forma')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('tipo_tanque') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="">Seleccione...</option>
                                    <option value="atmosferico" {{ old('tipo_tanque', $tanque['tipo_tanque']) == 'atmosferico' ? 'selected' : '' }}>Atmosférico</option>
                                    <option value="soterrado" {{ old('tipo_tanque', $tanque['tipo_tanque']) == 'soterrado' ? 'selected' : '' }}>Soterrado</option>
                                    <option value="areometro" {{ old('tipo_tanque', $tanque['tipo_tanque']) == 'areometro' ? 'selected' : '' }}>Areómetro</option>
                                </select>
                                @error('tipo_tanque')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="material" 
                                       name="material" 
                                       value="{{ old('material', $tanque['material']) }}" 
                                       required>
                                @error('material')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('tipo_medicion') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="">Seleccione...</option>
                                    <option value="manual" {{ old('tipo_medicion', $tanque['tipo_medicion']) == 'manual' ? 'selected' : '' }}>Manual</option>
                                    <option value="automatica" {{ old('tipo_medicion', $tanque['tipo_medicion']) == 'automatica' ? 'selected' : '' }}>Automática</option>
                                </select>
                                @error('tipo_medicion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('unidad_medida') is-invalid @enderror" 
                                        ...
                                        required>
                                    <option value="">Seleccione...</option>
                                    <option value="litros" {{ old('unidad_medida', $tanque['unidad_medida']) == 'litros' ? 'selected' : '' }}>Litros</option>
                                    <option value="galones" {{ old('unidad_medida', $tanque['unidad_medida']) == 'galones' ? 'selected' : '' }}>Galones</option>
                                    <option value="barriles" {{ old('unidad_medida', $tanque['unidad_medida']) == 'barriles' ? 'selected' : '' }}>Barriles</option>
                                </select>
                                @error('unidad_medida')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('precision_medicion', $tanque['precision_medicion']) }}" 
                                       min="0" 
                                       step="0.001">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('factor_correccion', $tanque['factor_correccion']) }}" 
                                       min="0" 
                                       step="0.0001">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_nivel_min', $tanque['umbral_nivel_min']) }}" 
                                       min="0" 
                                       max="100">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_nivel_max', $tanque['umbral_nivel_max']) }}" 
                                       min="0" 
                                       max="100">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_temperatura_min', $tanque['umbral_temperatura_min']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_temperatura_max', $tanque['umbral_temperatura_max']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_presion_min', $tanque['umbral_presion_min']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('umbral_presion_max', $tanque['umbral_presion_max']) }}" 
                                       step="any">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       id="latitud" 
                                       name="latitud" 
                                       value="{{ old('latitud', $tanque['latitud']) }}" 
                                       step="any">
                                @error('latitud')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                <input type="checkbox" 
                                       ...
                                       name="activo" 
                                       value="1" 
                                       {{ old('activo', $tanque['activo']) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('tanques.show', $tanque['id']) }}" class="btn btn-info">
