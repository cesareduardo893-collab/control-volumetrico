    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Producto: {{ $producto['nombre'] }}</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('productos.update', $producto['id']) }}" id="productoForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="clave_producto" 
                                       name="clave_producto" 
                                       value="{{ old('clave_producto', $producto['clave_producto']) }}" 
                                       maxlength="50"
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" 
                                    ...
                                    <option value="gasolina" {{ old('tipo', $producto['tipo']) == 'gasolina' ? 'selected' : '' }}>Gasolina</option>
                                    <option value="diesel" {{ old('tipo', $producto['tipo']) == 'diesel' ? 'selected' : '' }}>Diesel</option>
                                    <option value="combustoleo" {{ old('tipo', $producto['tipo']) == 'combustoleo' ? 'selected' : '' }}>Combustóleo</option>
                                    <option value="petroleo" {{ old('tipo', $producto['tipo']) == 'petroleo' ? 'selected' : '' }}>Petróleo</option>
                                    <option value="queroseno" {{ old('tipo', $producto['tipo']) == 'queroseno' ? 'selected' : '' }}>Queroseno</option>
                                    <option value="otros" {{ old('tipo', $producto['tipo']) == 'otros' ? 'selected' : '' }}>Otros</option>
                                </select>
                                @error('tipo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="clave_sat" 
                                       name="clave_sat" 
                                       value="{{ old('clave_sat', $producto['clave_sat']) }}" 
                                       maxlength="20"
                                       required>
                                @error('clave_sat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="clave_unidad" 
                                       name="clave_unidad" 
                                       value="{{ old('clave_unidad', $producto['clave_unidad']) }}" 
                                       maxlength="10"
                                       required>
                                @error('clave_unidad')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('temperatura_referencia', $producto['temperatura_referencia']) }}" 
                                       step="0.1"
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('factor_correccion', $producto['factor_correccion']) }}" 
                                       min="0" 
                                       step="0.0001"
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('rango_temperatura_min', $producto['rango_temperatura_min']) }}" 
                                       step="0.1"
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('rango_temperatura_max', $producto['rango_temperatura_max']) }}" 
                                       step="0.1"
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('rango_presion_min', $producto['rango_presion_min']) }}" 
                                       step="0.1"
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('rango_presion_max', $producto['rango_presion_max']) }}" 
                                       step="0.1"
                                       required>
